...
Utilize o arquivo bilheteria.py disponível em nossa sala de aula do Google
Classroom para testar as classes.'''
...
class Ingresso:
    ...
    def __str__(self) -> str:
        return f'O valor do ingresso é {self.valor} e o status é {self.status}, {i.codigo}'
